package org.web.sdk.system.events 
{
	...
	{
		public static const COM:int = 2;				//命令推送
		public static const CLIENT:int = 1;				//客服端推送
		public static const SERVER:int = 3;				//服务器发送
		public static const NONE_TYPE:int = -1;			//无类型表示
		//
