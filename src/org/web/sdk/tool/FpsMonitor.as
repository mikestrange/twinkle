package org.web.sdk.tool 
{
	...
	public class FpsMonitor extends Sprite
	{
		 ...
		 */
		public function FpsMonitor( _theme : Object = null ) : void
		{
			if (_theme)
			{
		...
		public function show(father:DisplayObjectContainer = null):void
		{
			...
			else AppWork.stage.addChild(this);
		}
		...
		public static function gets():FpsMonitor
		{
			if (null == _ins) _ins = new FpsMonitor;
			return _ins;
		}
