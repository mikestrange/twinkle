package org.web.sdk.tool 
{
	...
	public class SystemScope
	{
		...
		public function SystemScope(maxw:Number = 500, maxh:Number = 400) 
		{
			maxWidth = maxw;
			maxHeight = maxh;
			FrameWork.stage.addEventListener(Event.RESIZE, update);
			update();
		...
		{
			var dw:Number = FrameWork.stage.stageWidth;
			var dh:Number = FrameWork.stage.stageHeight;
		...
		public function dispose():void
		{
			...
			_x = 0;
			_y = 0;
			FrameWork.stage.removeEventListener(Event.RESIZE, update);
		}
