package org.web.sdk.tool 
{
	...
	public class SystemScope
	{
		...
		public function SystemScope(maxw:Number = 500, maxh:Number = 400) 
		{
			maxWidth = maxw;
			maxHeight = maxh;
			Mentor.stage.addEventListener(Event.RESIZE, update);
			update();
		...
		{
			var dw:Number = Mentor.stage.stageWidth;
			var dh:Number = Mentor.stage.stageHeight;
		...
		public function dispose():void
		{
			...
			_x = 0;
			_y = 0;
			Mentor.stage.removeEventListener(Event.RESIZE, update);
		}
