package org.web.sdk.frame.made.core 
{
	...
	import org.web.sdk.frame.made.tracker.Tracker;
	import org.web.sdk.frame.made.wrapper.ClassWrapper;
	import org.web.sdk.frame.made.wrapper.MethodWrapper;
	import org.web.sdk.frame.made.wrapper.MixtureWrapper;
	import org.web.sdk.frame.made.wrapper.TactVector;
	/*
	 *  [集装箱模式]
	 * 一个对象一个集装箱模式就够了
