/**
 * VERSION: 5.party.greensockparty.greensockparty.greensockparty.greensock1
 *party.greensockparty.greensock DATE: 2010-12-09
 * AS3
 * UPDATES AND DOCS AT: http://www.greensock.com/tweenvars/
 **/
package party.greensock.data {
	import party.greensock.TweenLite;
	import party.greensock.TweenMax;
	import party.greensock.motionPaths.MotionPath;
...
//---- BUILT-IN SPECIAL PROPERTIES (NO PLUGIN ACTIVATION REQUIRED) --------------------------------------------------------------
		 ...
		 * 
		 * @param ease An easing function (i.e. <code>party.greensock.easing.Elastic.easeOut</code>) The default is <code>Quad.easeOut</code>.
...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 * <b>USAGE:</b><br /><br />
		 * <code>
		 * 		import party.greensock.TweenMax; <br />
		 * 		import party.greensock.data.TweenMaxVars; <br /><br />
		 * 
		 ...
		 * <code>
		 * 		import party.greensock.TweenMax; <br />
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.~~; <br />
		 * 		import party.greensock.motionPaths.~~<br />
		 ...
		 * </code>
		 * 
		 * @param path The CirclePath2D instance to follow (<code>party.greensock.motionPaths.CirclePath2D</code>)
		 ...
		 * <code>
		 * 		import party.greensock.TweenMax; <br />
		 * 		import party.greensock.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.Physics2DPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.PhysicsPropsPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.ScrollRectPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.SetSizePlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.ShortRotationPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.SoundTransformPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.StageQualityPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.TransformAroundCenterPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.TransformAroundPointPlugin; <br />
		 ...
		 * 		import party.greensock.data.TweenMaxVars; <br />
		 * 		import party.greensock.plugins.TweenPlugin; <br />
		 * 		import party.greensock.plugins.TransformMatrixPlugin; <br />
